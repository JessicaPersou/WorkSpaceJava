...
public class Main {
    public static void main(String[] args) {
        ...
        FolhaPagamento joao = new FolhaPagamento();
        joao.horasNormais = 160;
        joao.QtdHorasNormaisTrabalhadas = 50.75;
        joao.horasExtras = 58;
        joao.QtdHorasExtrasTrabalhadas = 75.25;
        ...
        //MÉTODO DA CLASSE DESCONTO EMPREGRADO E PESSOA
